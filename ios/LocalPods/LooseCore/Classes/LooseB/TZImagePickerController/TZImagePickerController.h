...
#pragma mark - 自定义样式修改isCustomUI
@property (nonatomic, assign) BOOL isCustomUI;
@property (nonatomic, assign) BOOL hasSelectPhoto;
@property (nonatomic, copy)   NSString *reportVideoDuration;
@property (nonatomic, copy)   void(^doneButtonClickNoData)(void);
@property (nonatomic, copy)   void(^selectVideoBlock)(PHAsset *asset);
