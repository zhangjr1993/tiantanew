...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _iCloudErrorIcon.image = [UserTextImage imageNamed:@"iCloudError"];
        ...
        _iCloudErrorLabel.text = @"iCloud无法同步";
...
- (void)configPlayButton {
    ...
    [_playButton setImage:[UserTextImage imageNamed:@"MMVideoPreviewPlay"] forState:UIControlStateNormal];
    [_playButton setImage:[UserTextImage imageNamed:@"MMVideoPreviewPlayHL"] forState:UIControlStateHighlighted];
