 ...
 *  @return header数组
 */
- ( NSArray<__kindof NSString *> * _Nullable )menuTitlesForMagicView:(VTMagicView *)magicView;
 ...
 *  @return 当前索引对应的菜单按钮
 */
- ( UIButton * _Nullable )magicView:(VTMagicView *)magicView menuItemAtIndex:(NSUInteger)itemIndex;
 ...
 *  @return 页面控制器
 */
- ( UIViewController * _Nullable )magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex;
