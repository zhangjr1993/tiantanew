 ...
 *  @return 当前索引对应的按钮
 */
- (UIButton *_Nullable)menuBar:(VTMenuBar *)menuBar menuItemAtIndex:(NSUInteger)itemIndex;
 ...
 */
- (__kindof UIButton *_Nullable)dequeueReusableItemWithIdentifier:(NSString *_Nullable)identifier;
